...
class DBManager:
    ...
    def init_db(self):
        ...
        try:
            ...
            ('auto_backup_enabled', 'false', '是否启用数据库自动备份'),
            ('auto_backup_interval_hours', '24', '数据库自动备份间隔（小时）'),
            ('auto_backup_keep_count', '7', '数据库自动备份保留数量'),
            ('auto_backup_last_run', '', '数据库自动备份最后执行时间'),
            ('auto_backup_last_status', '', '数据库自动备份最近执行状态'),
            ('auto_backup_last_file', '', '数据库自动备份最近生成文件'),
